...
export const Icons = {
  ...
  warning: ({ size = 16, style, ...props }: IconProps) => (
    <svg
      ...
      style={{ width: size, height: size, ...style }}
      {...props}
      stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
